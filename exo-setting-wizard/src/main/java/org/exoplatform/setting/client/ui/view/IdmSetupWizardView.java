...
public class IdmSetupWizardView extends WizardView {
  ...
  public IdmSetupWizardView(SetupWizardController controller, SetupWizardMode mode) {
    super(controller, SetupScreen.IDM_SETUP);
  }

  @Override
  protected String getWizardTitle() {
    return constants.usersAndGroups();
  }
  ...
  public Map<SetupWizardData, String> verifyDatas() throws WizardInvalidFieldException {
    ...
    // Change mode
    if(dbRadio.getValue().equals(true)) {
      controller.setSetupWizardIdmMode(SetupScreen.IDM_DB);
    }
    else {
      controller.setSetupWizardIdmMode(SetupScreen.IDM_LDAP);
    }
