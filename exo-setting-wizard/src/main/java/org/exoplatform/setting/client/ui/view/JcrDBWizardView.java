...
public class JcrDBWizardView extends WizardView {
  ...
  public JcrDBWizardView(SetupWizardController controller, SetupWizardMode mode) {
    super(controller, SetupScreen.JCR_DB);
  ...
  protected Widget buildStepContent() {
    ...
    // Pre select an item
    int preselectedItem = WizardClientUtility.getPreselectedItemIndex(dss, "jcr");
