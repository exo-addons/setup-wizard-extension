...
public class SystemWizardView extends WizardView {
  ...
  public SystemWizardView(SetupWizardController controller, SetupWizardMode mode) {
    super(controller, SetupScreen.SETUP_INFO);
   ...
   * @return
   */
  private int getIndexByLanguagesValue(ListBox languages, String language) {
    if(languages != null) {
