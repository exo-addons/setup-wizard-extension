...
public class WebsiteWizardView extends WizardView {
  ...
  public WebsiteWizardView(SetupWizardController controller, SetupWizardMode mode) {
    super(controller, SetupScreen.WEBSITES);
  }
  ...
  protected Widget buildStepContent() {
    ...
    blankPortal.setValue(true);
    
    // TODO get all installed WebSites
