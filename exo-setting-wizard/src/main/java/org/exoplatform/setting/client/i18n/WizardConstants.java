...
public interface WizardConstants extends Constants {
  ...
  @DefaultStringValue("Please wait a few minutes while your server is restarting.<br />You can watch important logs:")
  ...
  @DefaultStringValue("JCR Database")
  String jcrDbSetup();

  @DefaultStringValue("The Database will be used to host the JCR.<br />You need to install your Database driver.")
  ...
  @DefaultStringValue("Organization Model")
  String idmSetupDesc();
  ...
  @DefaultStringValue("Database to store users and groups")
  String idmDbSetup();

  @DefaultStringValue("The Database will be used to host the IDM.<br />You need to install your Database driver.")
  ...
  @DefaultStringValue("An error has occured")
  String errorDesc();
}
