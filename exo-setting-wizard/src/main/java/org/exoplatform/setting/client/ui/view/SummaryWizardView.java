...
public class SummaryWizardView extends WizardView {
  ...
  public SummaryWizardView(SetupWizardController controller, SetupWizardMode mode) {
    super(controller, SetupScreen.SUMMARY);
  }
      ...
      public void onClick(ClickEvent event) {
        ...
        AsyncCallback<String> callbackApply = new AsyncCallback<String>() {
          ...
          public void onFailure(Throwable arg0) {
            controller.displayError(arg0.getMessage());
          }

          public void onSuccess(String arg0) {
            controller.displayMessage(arg0);
            controller.displayScreen(getScreen().getNextScreen());
          }
        };
        
        controller.writeProperties(callbackApply);
      }
    });
    return button;
  }
